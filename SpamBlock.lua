...
local blacklist = T{'Frededde','Comedie','Boamna','Thanatoss','Lowesquadone','Justchao','Jamiei','Bazzarcat','Aboschitt','Wooohoo','Aeoniczaca','Yagwick'} -- Blocks all messages from defined player-characters entered here, E.G. 'Spammerguy','Badguy', etc. 

-- Blacklist Reasons:
-- Frededde - Racist, sexist, asshole.
-- Comedie, Boamna, Thanatoss, Lowesquadone, Justchao, Jamiei, Bazzarcat, Aboschitt, Wooohoo, Aeoniczaca, Yagwick - Mercing
