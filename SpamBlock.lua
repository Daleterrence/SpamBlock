...
windower.register_event('gain focus', check_for_update)
windower.register_event('weather change', check_for_update)

local blacklist = T{'Comedie','Boamna','Thanatoss','Lowesquadone','Justchao','Jamiei','Bazzarcat','Aboschitt','Wooohoo','Aeoniczaca','Aeoniczzzcq','Yagwick','Criofan','Attkins','Yagwica','Senaki','Killera','Killerfa','Xxzzgorun','Deshutzn','Pangge','Yagwicc','Killerfd','Chirich'} -- Blocks all messages from defined player-characters entered here, E.G. 'Spammerguy','Badguy', etc. 

local black_listed_words = T{string.char(0x81,0x69),string.char(0x81,0x99),string.char(0x81,0x9A),'CP500p','2100p','ML0-20/15m','New2025','V0toV25', '3M/run', '3M/hour', 'Aeonic Weapon*.*Mind','2100/20M','T1T2T3T4','3 Area Clear Mind','boosted v25','OdysseyNM T1-T2/V0-V25 T3/V0-V25 T4/V0-V25','DYDW3Clear.HTBC.VD*','Dynamis*.*Buy?'} -- Strings the addon will look for in yell and shout chat, and block appropriately.
-- Example Strings:
